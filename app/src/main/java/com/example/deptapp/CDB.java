...
public class CDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table tbDept (dno interger primary key autoincrement,dname text,dloc text)");
    }
    ...
    public String[] getOneDepartment(int dno) {
        ...
        try {
            ...
            Cursor cursor = db.query("Tbdept", new String[]
                    {"dno", "dname", "dloc"}, "dno" + "=?", new String[]{String.valueOf(dno)}, null, null, null, null);
